...
if __name__ == "__main__":
    ...
    # # run mirt.R
    # os.chdir("..")
    # subprocess.run("conda run -n R Rscript mirt.R", shell=True, check=True)
    ...
    #         new_df.to_csv(f'../data/real/irt_reslult/Z/{perturb}_{model}_Z_clean.csv', index=False)
    ...
    #     perturb1_coef = pd.read_csv(f'../data/real/irt_reslult/theta/perturb1_{model}_Z_clean.csv')
    #     perturb2_coef = pd.read_csv(f'../data/real/irt_reslult/theta/perturb2_{model}_Z_clean.csv')
    ...
    base_coef_1PL = pd.read_csv('../data/real/irt_reslult/Z/base_1PL_Z_clean.csv')
    ...
    theta_df = pd.read_csv('../data/real/irt_reslult/theta/base_1PL_theta.csv')
