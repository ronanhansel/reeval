...
#     python calibrate.py --dataset $dataset --PL 1 --fitting_method mle& 
# done

# for dataset in "${datasets[@]}"; do
#     echo "Calibrating $dataset 2PL"
#     python calibrate.py --dataset $dataset --PL 2 --fitting_method mle& 
# done
...
for dataset in "${datasets[@]}"; do
    echo "Calibrating $dataset 1PL"
    python calibrate.py --dataset $dataset --PL 1 --fitting_method em& 
done

# for dataset in "${datasets[@]}"; do
#     echo "Calibrating $dataset 2PL"
#     python calibrate.py --dataset $dataset --PL 2 --fitting_method em& 
# done
