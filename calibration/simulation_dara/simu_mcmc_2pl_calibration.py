...
if __name__ == "__main__":
    # wandb.init(project="simu_mcmc_2pl_calibration")
    ...
    output_dir = f"../data/simu_mcmc_2pl_calibration/{args.dataset}"
    plot_dir = f"../plot/simu_mcmc_2pl_calibration/{args.dataset}"
