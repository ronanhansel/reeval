...
class GPTBatcher:
    ...
    def __init__(self, api_key, model_name="gpt-3.5-turbo-0125", system_prompt="",temperature=1,max_token=256,num_workers=64,timeout_duration=60,retry_attempts=2,api_base_url=None):
