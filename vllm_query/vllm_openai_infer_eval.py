...
for model_string in subset_model_string_list:
    ...
    with open(f'answer_{model_string}_result.csv', 'r', newline='', encoding='utf-8') as infile:
    ...
    with open(f'eval_{model_string}_result.csv', 'w', newline='', encoding='utf-8') as outfile:
